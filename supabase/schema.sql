...
-- creó unas líneas más arriba, para agregarle la columna `modos`. Y su §6
-- vuelve a definir `crear_reporte`, para admitir los objetos 'proveedor' y
-- 'resena'. En una instalación nueva se ejecutan las dos versiones de cada
-- una y manda la segunda, que es la buena. No se fusionaron a mano para
-- que este archivo siga siendo el volcado literal de las migraciones y no
-- una tercera versión que nadie sabe de dónde salió.
-- =====================================================================
...
--
-- Volcado de `supabase/migraciones/v3-s6-resenas.sql`.
-- =====================================================================
...
--
-- Volcado de `supabase/migraciones/v3-s7-moderacion.sql`. Su §1 vuelve a
-- definir `resolver_reporte`, que ya aparece más arriba: manda esta.
-- =====================================================================
...
-- =====================================================================
-- v3 · Fase S8 — Comuna y zona a la vez, y las zonas propuestas
--
-- Volcado de `supabase/migraciones/v3-s8-zonas.sql`. Vuelve a definir
-- `guardar_proveedor`, `crear_proveedor_asistido`,
-- `crear_solicitud_servicio`, `proveedores_de_mi_organizacion` y
-- `panel_admin_servicios`, que ya aparecen mas arriba: mandan estas.
-- =====================================================================
