-- Municipios de Colombia (código DANE oficial). Generado desde datos.gov.co, dataset gdxc-w37w (DANE, Divipola: municipios, áreas no municipalizadas e isla).
insert into public.municipios (codigo_dane, nombre, departamento) values
  ...
  ('05042','Santa Fé de Antioquia','Antioquia'),
  ...
  ('54001','San José de Cúcuta','Norte de Santander'),
  ...
  ('70823','San José de Toluviejo','Sucre'),
  ('73001','Ibagué','Tolima'),
  ...
  ('76001','Santiago de Cali','Valle del Cauca'),
