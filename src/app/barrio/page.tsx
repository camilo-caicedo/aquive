  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-6">
      ...
      {/* Búsqueda por GET: el resultado tiene URL propia y se puede compartir,
          igual que los filtros del directorio. */}
      <form action="/barrio" className="mt-4 flex gap-2">
        {params.municipio && (
        ...
        <button
          type="submit"
          className="bg-primary text-primary-foreground shadow-boton active:shadow-boton-hundido flex size-12 shrink-0 items-center justify-center rounded-full transition-all active:translate-x-[2px] active:translate-y-[2px]"
          aria-label="Buscar"
        >
