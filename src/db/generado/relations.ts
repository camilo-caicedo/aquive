...
export const pushAvisosRelations = relations(pushAvisos, ({one}) => ({
	perfile: one(perfiles, {
		fields: [pushAvisos.perfilId],
		references: [perfiles.id]
	}),
}));
